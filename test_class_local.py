...
# import from project
from classification_localisation import class_local
...
x_left = float(box_pred[0][0]) * 240
y_top = float(box_pred[0][1]) * 240
x_width = float(box_pred[0][2]) * 240
y_heigth = float(box_pred[0][3]) * 240

x_min = x_left - x_width / 2
y_min = y_top - y_heigth / 2
x_max = x_left + x_width / 2
y_max = y_top + y_heigth / 2
